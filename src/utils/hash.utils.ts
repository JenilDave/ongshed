...
export const verifyPassword = (hashed_pass: string, pass: string) => new Promise(async (resolve, reject) => {
    try {
...
export const generateJwt = (username: string) => new Promise(async (resolve, reject) => {
    try {
...
export const verifyJwt = (token: string) => new Promise(async (resolve, reject) => {
    try {
